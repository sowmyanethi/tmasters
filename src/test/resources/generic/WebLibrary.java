...
/* ######################################################################################################
 * Class Name: WebLib
 * Description: Contains the methods which are generic to all web applications
 ...
 */
	...
	/* ######################################################################################################
	 * Method Name: VerifyCellText
	 * Description: To verify cell text from WebTable
	 * Input Parameters: TableXpath, Row, Column, celltext
	 * Output: True/False
	 * Author: Testing Master
	 * Organization: Testing Master Technologies
	 * Date Created: 14-Mar-2016
	...
	public static Boolean VerifyCellText(String TableXpath,int row, int column, String celltxt)
	{
		Boolean stepStatus = true;
 ...
 */
	...
	public static Boolean fgmousehover(String xpathmousehove){
		Boolean stepstatus=true;
		try{
			Highlight(xpathmousehove);
			WebElement mousehover=driver.findElement(By.xpath(xpathmousehove));
